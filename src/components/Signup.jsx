  ...
  return (
    <div className="w-full bg-gray-200 h-screen flex justify-center items-center">
      <div className="w-4/12 p-4 rounded-xl bg-white shadow-lg">
        ...
        <div className="flex flex-col">
          <label htmlFor="nameDescription" className="my-2 text-gray-600">
            Full Name
          </label>
          <input
            id="nameDescription"
          ...
          />
          <span id="nameDescription" className="sr-only">
            Please enter your email address.
          </span>
        </div>
        <div className="flex flex-col">
        ...
        <Link to="/login">
          <p className="text-center text-gray-500">Already have account</p>
        </Link>
      </div>
    </div>
  );
